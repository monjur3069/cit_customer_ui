...
class AddSupportScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var controller = Get.find<AddSupportController>();
    return Scaffold(
      appBar: AppBar(
        ...
        child: Column(
          ...
          children: [
            const Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                CommonTextWidget(text: 'Support Title : ',fontSize: 16,fontWeight: FontWeight.w600,),
                SizedBox(width: 2,),
                Icon(Icons.star,size: 10,color: primaryRed,)
              ],
            ),
            const SizedBox(height: 10,),
            CommonTextFormField(hintText: 'Write support title here', controller: controller.supportTitleController),
            ...
            const Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                CommonTextWidget(text: 'Support Description : ',fontSize: 16,fontWeight: FontWeight.w600,),
                SizedBox(width: 2,),
                Icon(Icons.star,size: 10,color: primaryRed,)
              ],
            ),
            const SizedBox(height: 10,),
            CommonTextFormField(hintText: 'Write support description here', controller: controller.supportDescriptionController,maxLine: 15,),
            const SizedBox(height: 20,),
