...
class BottomSheetSupport extends StatelessWidget {
  final String title;
  final String description;
  const BottomSheetSupport({required this.title,required this.description,super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    const CommonTextWidget(text: 'Admin Reply : ',fontSize: 14,fontColor: primaryBlack,fontWeight: FontWeight.w600,),
